...
public class ServerDBmsgs {
	...
	public static final String ERROR_DURING_DB_OPERATION = "Error occured while fetching results of request";

	public static final String REQUSET_FOR_EMPTY_TERM_MSG = "Can't use empty string";
